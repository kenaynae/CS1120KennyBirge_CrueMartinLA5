...
public class EnergyAnalyzer implements IRover {
	...
	/**
	 * This method finds the energy in the path and sets the analysis field
	 */
	 ...
	 * 
	 * @return analysis this is the value of the energy in the entire path
	 */
	 ...
	 * 
	 * @param analysis this is the value of the energy in the entire path
	 */
